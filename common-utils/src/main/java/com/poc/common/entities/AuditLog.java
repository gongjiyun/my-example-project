...
public class AuditLog implements Serializable{
	...
	@TableGenerator(name="auditlogid_gen",table="Classes_",pkColumnName="className",initialValue=1, valueColumnName="currentId",pkColumnValue="com.poc.common.entities.AuditLog",allocationSize=1)
