...
public class CodeMaster implements Serializable{
	...
	@TableGenerator(name="codemasterid_gen",table="Classes_",pkColumnName="className",initialValue=1, valueColumnName="currentId",pkColumnValue="com.poc.common.entities.CodeMaster",allocationSize=1)
