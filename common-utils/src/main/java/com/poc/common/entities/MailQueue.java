...
public class MailQueue implements Serializable{
	...
	@TableGenerator(name="mailqueueid_gen",table="Classes_",pkColumnName="className",initialValue=1, valueColumnName="currentId",pkColumnValue="com.poc.common.entities.MailQueue",allocationSize=1)
