...
@Table(name="PB_Resource",catalog="",schema="")
public class Resource implements Serializable{
	...
	@TableGenerator(name="resourceid_gen",table="PB_Classes_",pkColumnName="className",initialValue=1, valueColumnName="currentId",pkColumnValue="sg.ncs.digitalbanking.entity.Resource",allocationSize=1)
