...
public class UserProfile implements Serializable{
	...
	@TableGenerator(name="userprofileid_gen",table="Classes_",pkColumnName="className",initialValue=1, valueColumnName="currentId",pkColumnValue="com.learning.common.entities.UserProfile",allocationSize=1)
