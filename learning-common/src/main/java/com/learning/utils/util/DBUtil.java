...
public class DBUtil {
    ...
    protected static class AnnoTable {
        ...
        private Map<String, AnnoField> fieldMap;

        public AnnoTable() {
            fieldMap = new ConcurrentHashMap<String, AnnoField>();
        }
        ...
        private Map<String, AnnoField> getFieldMap() {
            return fieldMap;
        }

        private void setFieldMap(Map<String, AnnoField> fieldMap) {
    ...
    protected static class AnnoField {
        ...
        private String getFiledGetMethodName() {
            return filedGetMethodName;
        }

        private void setFiledGetMethodName(String filedGetMethodName) {
            this.filedGetMethodName = filedGetMethodName;
        }

        private String getFiledSetMethodName() {
            return filedSetMethodName;
        }

        private void setFiledSetMethodName(String filedSetMethodName) {
        ...
        private void setBasicType(boolean basicType) {
            this.basicType = basicType;
        }

        private void setIdAnno(Id idAnno) {
            this.idAnno = idAnno;
        }
        ...
        private void setColumnAnno(Column columnAnno) {
        ...
        private void setCtype(String ctype) {
            this.ctype = ctype;
        }
