...
@Table(name="PB_CodeMaster",catalog="",schema="")
public class CodeMaster implements Serializable{
	...
	@TableGenerator(name="codemasterid_gen",table="PB_Classes_",pkColumnName="className",initialValue=1, valueColumnName="currentId",pkColumnValue="sg.ncs.digitalbanking.entity.CodeMaster",allocationSize=1)
