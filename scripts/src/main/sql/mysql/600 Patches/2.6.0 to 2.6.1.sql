...
ALTER TABLE TBL_MC_SETTING ADD(HIDE_MUTUALLY_EXCLUSIVE VARCHAR(2) DEFAULT '0',HIDE_MARKABLE VARCHAR(2) DEFAULT '0');
ALTER TABLE TBL_MC_SETTING ADD(HIDE_SUPPORTED_DEVICES VARCHAR(2) DEFAULT '0', HIDE_META_DATA VARCHAR(2) DEFAULT '0', HIDE_DISTRIBUTION_MODES VARCHAR(2) DEFAULT '0');

/* Add column 'fullCategoryPath' to resolve issue  */
ALTER TABLE `TBL_MC_CATEGORY` ADD FULL_CATEGORY_PATH TEXT;