...
public class Groups implements Serializable{
	...
	@TableGenerator(name="groupsid_gen",table="Classes_",pkColumnName="className",initialValue=1, valueColumnName="currentId",pkColumnValue="com.xxooframe.common.entities.Groups",allocationSize=1)
