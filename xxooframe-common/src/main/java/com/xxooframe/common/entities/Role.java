...
public class Role implements Serializable{
	...
	@TableGenerator(name="roleid_gen",table="Classes_",pkColumnName="className",initialValue=1, valueColumnName="currentId", pkColumnValue="com.xxooframe.common.entities.Role",allocationSize=1)
