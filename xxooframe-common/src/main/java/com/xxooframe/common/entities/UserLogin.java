...
public class UserLogin implements Serializable{
	...
	@TableGenerator(name="userloginid_gen",table="Classes_",pkColumnName="className",initialValue=1, valueColumnName="currentId",pkColumnValue="com.xxooframe.common.entities.UserLogin",allocationSize=1)
