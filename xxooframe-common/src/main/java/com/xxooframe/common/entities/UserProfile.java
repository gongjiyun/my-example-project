...
public class UserProfile implements Serializable{
	...
	@TableGenerator(name="userprofileid_gen",table="Classes_",pkColumnName="className",initialValue=1, valueColumnName="currentId",pkColumnValue="com.xxooframe.common.entities.UserProfile",allocationSize=1)
